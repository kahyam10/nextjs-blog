...
const WhatsAppContactListItem: React.FC<Props> = ({
  contact,
  active,
  setActive,
}) => {
  function getLastMessage(conversation: IWhatsapp[]) {
...
export default WhatsAppContactListItem;
